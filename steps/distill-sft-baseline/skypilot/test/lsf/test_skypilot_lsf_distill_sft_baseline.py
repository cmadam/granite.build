...
"""Integration test: distill-sft-baseline runs end to end on Skypilot/LSF.
...
fixtures in the matching ``test-data/lsf/``. Run it from the step directory::
    ...
    GB_STEP_BLUEVELA_BUILD=1 make -C steps/distill-sft-baseline/skypilot test
...
class TestSkypilotLsfDistillSftBaseline(AbstractYamlBuildRunnerTest):
    ...
    def _get_yaml_spec_dir(self) -> Path:
        ...
        #   Mode 1 (authoring)  steps/distill-sft-baseline/skypilot/test/lsf/
        #       -> steps/distill-sft-baseline/skypilot/test-data/lsf/   (co-located)
        #   Mode 2 (published)  test/steps/distill-sft-baseline/skypilot/lsf/
        #       -> test-data/steps/distill-sft-baseline/skypilot/lsf/   (parallel tree)
